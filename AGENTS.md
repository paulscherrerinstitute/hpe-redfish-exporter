...
### Key Metrics
- **Lustre**: `hpe_redfish_clusterstor_lustre_*` (read_ops, write_ops, space_bytes, inodes)
- **System**: `hpe_redfish_clusterstor_node_*` (health, power_state, cpu_utilization)
- **Events**: `hpe_redfish_clusterstor_events_*` (total, severity)
